...
backend-developer → capas del proyecto (controllers/services/repositories/models)
frontend-developer→ UI opcional (si existe frontend)

[FASE 3 — Paralelo ∥]
test-engineer-backend  → ms-*/src/test/java/
test-engineer-frontend → frontend/src/__tests__/ (si aplica)
