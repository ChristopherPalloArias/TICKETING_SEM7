...
|---|---|
| `ms-*/src/main/java/**/*.java` (o equivalente) | `instructions/backend.instructions.md` |
| `api-gateway/**` / `frontend/**` (si aplica) | `instructions/frontend.instructions.md` |
| `ms-*/src/test/**/*.java` / `frontend/src/__tests__/**` | `instructions/tests.instructions.md` |
...
└── .github/                         ← framework Copilot (auto-contenido para compartir)
    ...
    │   ├── backend.instructions.md  ← applyTo: ms-*/src/main/java/**
    │   ├── frontend.instructions.md ← applyTo: api-gateway/**, frontend/**
    │   └── tests.instructions.md    ← applyTo: ms-*/src/test/**
    │
