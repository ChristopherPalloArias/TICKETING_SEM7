...
2. **Revisa el código existente** en `frontend/src/` para entender patrones actuales (si existe frontend).
...
5. **Verifica** el build del frontend según herramienta configurada.
...
- Los tokens de autenticación deben enviarse como `Bearer` en el header `Authorization` cuando aplique.
