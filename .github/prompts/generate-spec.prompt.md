...
- Modelos de datos (entidades/DTOs + PostgreSQL)
- Endpoints de API con request/response y errores
- Diseño de microservicios (api-gateway, ms-events, ms-ticketing, ms-notifications), incluyendo eventos RabbitMQ cuando aplique
