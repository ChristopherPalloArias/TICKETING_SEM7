...
public class RabbitMQConfig {
    ...
    public static final String USER_REGISTERED_QUEUE = "ticketing.user.registered";
    ...
    @Bean
    public Binding bindUserRegisteredQueue(Queue userRegisteredQueue, TopicExchange authExchange) {
